...
lowSelfEsteem_artist = ["하현우", "장범준", "마크툽", "볼빨간사춘기", "송하예",
                "멜로망스", "펀치", "10cm", "엔플라잉", "에픽하이"]

ideal_artist = ["엔플라잉", "악동뮤지션", "케이윌", "스탠딩에그", "백예린",
        "벤", "이하이", "하현우", "허각", "엑소",
...
notIdeal_artist = ["방탄소년단", "태연", "선미", "창모", "지코",
            "크러쉬", "송민호", "헤이즈", "기리보이", "마마무",
            "(여자)아이들", "장범준", "백지영", "잔나비", "김필",
            "규현", "바이브", "임창정", "10cm", "아이유",
            "레드벨벳", "에이핑크", "제시", "선미", "박봄"]

active_artist = ["아이유", "백지영", "장덕철", "이하이", "백예린",
        "박혜원", "스탠딩에그", "임영웅", "벤", "양다일",
...
notActive_artist = ["하현우", "엔플라잉", "에픽하이"]

patient_artist = ["아이유", "거미", "박혜원", "장덕철", "스탠딩에그",
            "임영웅", "벤", "양다일", "기리보이", "다비치",
            "윤하", "임창정", "백예린", "하현우", "엔플라잉",
...
notPatient_artist = ["마마무", "오마이걸", "블랙핑크", "있지", "에이핑크",
            "아이즈원", "트와이스", "청하", "송민호", "엑소",
            "장범준", "마크툽", "볼빨간사춘기", "송하예", "멜로망스",
            "펀치", "10cm"]

comfortable_artist = ["스탠딩에그", "허각", "장덕철", "이하이", "벤",
...
notComfortable_artist = ["아이유", "레드벨벳", "에이핑크", "제시", "선미",
                "박봄"]

hardworking_artist = ["마마무", "(여자)아이들", "김필", "바이브", "악동뮤지션",
            "폴킴", "볼빨간사춘기", "백지영", "청하", "크러쉬",
...
notHardworking_artist = ["엔플라잉", "펀치", "송하예", "멜로망스", "하현우",
                "에픽하이", "폴킴", "다비치", "임영웅", "규현",
                "윤하", "양다일", "노을", "악동뮤지션", "백예린",
                "엠씨더맥스", "벤", "케이윌", "박효신", "잔나비",
                "창모", "지코", "크러쉬", "송민호", "헤이즈",
...
extrovert_artist = ["백지영", "크러쉬", "헤이즈", "이하이", "기리보이",
            "장덕철", "폴킴", "임영웅", "규현", "양다일",
...
notExtrovert_artist = ["노을", "악동뮤지션", "백예린", "엠씨더맥스", "벤",
                "케이윌", "박효신", "펀치", "스탠딩에그", "먼데이키즈",
                "김필", "박진영", "바이브", "허각"]

realistic_artist = ["하현우", "엔플라잉", "에픽하이", "스탠딩에그", "먼데이키즈",
            "김필", "박진영", "바이브", "허각"]

notRealistic_artist = ["임영웅", "규현", "양다일", "방탄소년단", "장덕철"
            "폴킴", "다비치", "송하예", "윤하", "멜로망스",
            "트와이스", "제니", "엑소", "태연", "선미",
            "아이유", "백예린", "잔나비", "김필", "바이브",
